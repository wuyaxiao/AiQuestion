...
public class UserAnswerServiceImpl extends ServiceImpl<UserAnswerMapper, UserAnswer> implements UserAnswerService {
    ...
    @Override
    public boolean updateMyUserAnswer(UserAnswer userAnswer) {
        Long id = userAnswer.getId();
        ...
        updateWrapper.eq("id", id)
                        .set("appType",appType)
                        .set("scoringStrategy",scoringStrategy)
                        .set("resultId",resultId)
                        .set("resultName", resultName)
                        .set("resultDesc", resultDesc)
                        .set("resultPicture", resultPicture)
                        .set("resultScore",resultScore);
